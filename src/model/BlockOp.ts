...
class BlockOp extends MutationOp {
    ...
    static initializeComptroller(prevOp?: BlockOp): MiniComptroller {
        ...
        if (prevOp !== undefined) {
            ...
            comptroller.setBlockTimeFactor(MiniComptroller.initialBlockTimeFactor);
            comptroller.setMovingMaxSpeed(MiniComptroller.initialMovingMaxSpeed);
            comptroller.setMovingMinSpeed(MiniComptroller.initialMovingMinSpeed); 
            comptroller.setSpeedRatio(FixedPoint.divTrunc(comptroller.getMovingMaxSpeed(), comptroller.getMovingMinSpeed()));
        }
