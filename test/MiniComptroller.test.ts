...
describe('[STK] Staking and Pseudo-random Difficulty.', () => {
    ...
    test('[TIME01] test_lowBlockTime', () => {
        ...
        mc.addBlockSample( BigInt(20), BigInt(2000) )
        expect(mc.getBlockTimeFactor()).toEqual( BigInt(2000132275132275) )
        mc.addBlockSample( BigInt(20), BigInt(2000) )
        expect(mc.getBlockTimeFactor()).toEqual( BigInt(2000264559012905) )
        mc.addBlockSample( BigInt(20), BigInt(2000) )
        expect(mc.getBlockTimeFactor()).toEqual( BigInt(2000396851642469) )
    })
    ...
    test('[TIME02] test_hiBlockTime', () => {
        ...
        mc.setBlockNumber(MiniComptroller.bootstrapPeriod + BigInt(1))
        expect(mc.getBlockTimeFactor()).toEqual( BigInt(2000) * FixedPoint.UNIT )
        mc.addBlockSample( BigInt(60), BigInt(2000) )
        expect(mc.getBlockTimeFactor()).toEqual( BigInt(1999867724867724) )
        mc.addBlockSample( BigInt(60), BigInt(2000) )
        expect(mc.getBlockTimeFactor()).toEqual( BigInt(1999735458483804) )
        mc.addBlockSample( BigInt(60), BigInt(2000) )
        expect(mc.getBlockTimeFactor()).toEqual( BigInt(1999603200847660) )
    })
    ...
    // Speed ratio tests
     ...
     test('[TIME05] test_lowSpeedRatio', () => {
        ...
        mc.addBlockSample( BigInt(40), BigInt(350000) )
        expect(mc.getSpeedRatio()).toEqual( 2999603200846n  )
        expect(mc.getMovingMaxSpeed()).toEqual( 14999007936507936n )
        expect(mc.getMovingMinSpeed()).toEqual( 5000330687830687n )
        mc.addBlockSample( BigInt(40), BigInt(450000) )
        expect(mc.getSpeedRatio()).toEqual( 2999206454176n )
        expect(mc.getMovingMaxSpeed()).toEqual( 14998015938628537n )
        expect(mc.getMovingMinSpeed()).toEqual( 5000661397532263n )
        mc.addBlockSample( BigInt(40), BigInt(350000) )
        expect(mc.getSpeedRatio()).toEqual( 2998809759982n )
        expect(mc.getMovingMaxSpeed()).toEqual( 14997024006357463n )
        expect(mc.getMovingMinSpeed()).toEqual( 5000992129106173n )
    })
    ...
    test('[TIME05] test_hiSpeedRatio', () => {
        ...
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt(15000) * FixedPoint.UNIT )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt(5000) * FixedPoint.UNIT )
        mc.addBlockSample( BigInt(40), BigInt(2000) )
        expect(mc.getSpeedRatio()).toEqual( 3000198425821n  )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt(15000) * FixedPoint.UNIT )
        expect(mc.getMovingMinSpeed()).toEqual( 4999669312169312n )
        mc.addBlockSample( BigInt(40), BigInt(2000000) )
        expect(mc.getSpeedRatio()).toEqual( 3000396851643n )
        expect(mc.getMovingMaxSpeed()).toEqual( 15000992063492063n )
        expect(mc.getMovingMinSpeed()).toEqual( 4999669312169312n )
        mc.addBlockSample( BigInt(40), BigInt(2000) )
        expect(mc.getSpeedRatio()).toEqual( 3000595303713n )
        expect(mc.getMovingMaxSpeed()).toEqual( 15000992063492063n )
        expect(mc.getMovingMinSpeed()).toEqual( 4999338646209512n )
    })
    ...
    test('[TIME05] test_minSpeedRatio', () => {
        ...
        mc.addBlockSample( BigInt(40), BigInt(204000) )
        expect(mc.getSpeedRatio()).toEqual( 1299828053700n  )
        expect(mc.getMovingMaxSpeed()).toEqual( 6499570105820105n )
        expect(mc.getMovingMinSpeed()).toEqual( 5000330687830687n )
        mc.addBlockSample( BigInt(40), BigInt(204000) )
        expect(mc.getSpeedRatio()).toEqual( 1299828053700n )
        expect(mc.getMovingMaxSpeed()).toEqual( 6499570105820105n  )
    ...
    test('[TIME05] test_maxSpeedRatio', () => {
        ...
        mc.addBlockSample( BigInt(40), BigInt(160000) )
        expect(mc.getSpeedRatio()).toEqual( 3100204940009n  )
        expect(mc.getMovingMaxSpeed()).toEqual( 15499999500000000n )
        expect(mc.getMovingMinSpeed()).toEqual( 4999669312169312n )
        mc.addBlockSample( BigInt(40), BigInt(800000) )
        expect(mc.getSpeedRatio()).toEqual( 3100204940009n )
        expect(mc.getMovingMaxSpeed()).toEqual( 15501024632242063n  )
        expect(mc.getMovingMinSpeed()).toEqual( 4999999978129111n )
        mc.addBlockSample( BigInt(40), BigInt(160000) )
        expect(mc.getSpeedRatio()).toEqual( 3100204940009n )
        expect(mc.getMovingMaxSpeed()).toEqual( 15499999432200248n )
        expect(mc.getMovingMinSpeed()).toEqual( 4999669290299869n )
    })
    ...
    test('[STK12] test_difficulty_medSlot_bigRandomSeed_noise', () => {
        let mc = new MiniComptroller() as Comptroller;
        mc.setBlockNumber(MiniComptroller.bootstrapPeriod + BigInt(1)*FixedPoint.UNIT/FixedPoint.UNIT)
        expect( mc.getConsensusDifficulty( BigInt(1000), BigInt(10000), BigInt(5260998118755007034341642210716494845522350648952052609981187550070343416422107164948455223506489520n)) ).toEqual( BigInt(2048) )
        expect( mc.getConsensusDifficulty( BigInt(1000), BigInt(10000), BigInt(3526920428917842446652870866910534351362200027247135269204289178424466528708669105343513622000272471n)) ).toEqual( BigInt(6274) )
        expect( mc.getConsensusDifficulty( BigInt(1000), BigInt(10000), BigInt(1894014600641891233041722337274777069811451906366218940146006418912330417223372747770698114519063662n)) ).toEqual( BigInt(18008) )
        expect( mc.getConsensusDifficulty( BigInt(1000), BigInt(10000), BigInt(9331832644558941301556717332263302224461925824150393318326445589413015567173322633022244619258241503n)) ).toEqual( BigInt(56384) )
        expect( mc.getConsensusDifficulty( BigInt(1000), BigInt(10000), BigInt(7336086308650337759096410431252085093178178779429473360863086503377590964104312520850931781787794294n)) ).toEqual( BigInt(162196) )
    })

    test('[STK13] test_difficulty_bigSlot_bigRandomSeed_noise', () => {
        let mc = new MiniComptroller() as Comptroller;
        mc.setBlockNumber(MiniComptroller.bootstrapPeriod + BigInt(1)*FixedPoint.UNIT/FixedPoint.UNIT)
        expect( mc.getConsensusDifficulty( BigInt(10), BigInt(10000), BigInt(5260998118755007034341642210716494845522350648952052609981187550070343416422107164948455223506489520)) ).toEqual( BigInt(6867367640585024404965563169767424n) )
        expect( mc.getConsensusDifficulty( BigInt(10), BigInt(10000), BigInt(3526920428917842446652870866910534351362200027247135269204289178424466528708669105343513622000272471n)) ).toEqual( BigInt(6867367640585024404965563169767424n) )
        expect( mc.getConsensusDifficulty( BigInt(10), BigInt(10000), BigInt(1894014600641891233041722337274777069811451906366218940146006418912330417223372747770698114519063662n)) ).toEqual( BigInt(6867367640585024404965563169767424n) )
        expect( mc.getConsensusDifficulty( BigInt(10), BigInt(10000), BigInt(9331832644558941301556717332263302224461925824150393318326445589413015567173322633022244619258241503n)) ).toEqual( BigInt(6867367640585024404965563169767424n) )
        expect( mc.getConsensusDifficulty( BigInt(10), BigInt(10000), BigInt(7336086308650337759096410431252085093178178779429473360863086503377590964104312520850931781787794294n)) ).toEqual( BigInt(6867367640585024404965563169767424n) )
        expect( mc.getConsensusDifficulty( BigInt(10), BigInt(10000), BigInt(1236086308650337759096410431252085093178178779429473360863086503377590964104312520850931781787794005n)) ).toEqual( BigInt(500336) )
        expect( mc.getConsensusDifficulty( BigInt(10), BigInt(10000), BigInt(1236076308750327758096410431252085093178178779429473360863086503377590964104312520850931781787794014n)) ).toEqual( BigInt(10371246206) )
        expect( mc.getConsensusDifficulty( BigInt(10), BigInt(10000), BigInt(9216276108752326758096410431252085093178178779429473360863086503377590964104312520850931781787794194n)) ).toEqual( BigInt(6867367640585024404965563169767424n) )
    })
