...
describe('[STK] Staking and Pseudo-random Difficulty.', () => {
    ...
    // Speed ratio tests
     ...
     test('[TIME05] test_lowSpeedRatio', () => {
        ...
        expect(mc.getSpeedRatio()).toEqual( BigInt('2999603200846')  )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('14999007936507936') )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('5000330687830687') )
        mc.addBlockSample( BigInt(40), BigInt(450000) )
        expect(mc.getSpeedRatio()).toEqual( BigInt('2999206454176') )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('14998015938628537') )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('5000661397532263') )
        mc.addBlockSample( BigInt(40), BigInt(350000) )
        expect(mc.getSpeedRatio()).toEqual( BigInt('2998809759982') )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('14997024006357463') )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('5000992129106173') )
    })
    ...
    test('[TIME05] test_hiSpeedRatio', () => {
        ...
        expect(mc.getSpeedRatio()).toEqual( BigInt('3000198425821')  )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt(15000) * FixedPoint.UNIT )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('4999669312169312') )
        mc.addBlockSample( BigInt(40), BigInt(2000000) )
        expect(mc.getSpeedRatio()).toEqual( BigInt('3000396851643') )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('15000992063492063') )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('4999669312169312') )
        mc.addBlockSample( BigInt(40), BigInt(2000) )
        expect(mc.getSpeedRatio()).toEqual( BigInt('3000595303713') )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('15000992063492063') )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('4999338646209512') )
    })
    ...
    test('[TIME05] test_minSpeedRatio', () => {
        ...
        expect(mc.getSpeedRatio()).toEqual( BigInt('1299828053700')  )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('6499570105820105') )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('5000330687830687') )
        mc.addBlockSample( BigInt(40), BigInt(204000) )
        expect(mc.getSpeedRatio()).toEqual( BigInt('1299828053700') )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('6499570105820105')  )
    ...
    test('[TIME05] test_maxSpeedRatio', () => {
        ...
        expect(mc.getSpeedRatio()).toEqual( BigInt('3100204940009')  )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('15499999500000000') )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('4999669312169312') )
        mc.addBlockSample( BigInt(40), BigInt(800000) )
        expect(mc.getSpeedRatio()).toEqual( BigInt('3100204940009') )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('15501024632242063')  )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('4999999978129111') )
        mc.addBlockSample( BigInt(40), BigInt(160000) )
        expect(mc.getSpeedRatio()).toEqual( BigInt('3100204940009') )
        expect(mc.getMovingMaxSpeed()).toEqual( BigInt('15499999432200248') )
        expect(mc.getMovingMinSpeed()).toEqual( BigInt('4999669290299869') )
    })
